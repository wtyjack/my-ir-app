        ...
        get("/result.html", (request, response) -> {
            ...
            for(int i=0; i< result.size(); i++) {
            	...
            	try{
            		...
            		// check redirect (303)
            		String location;
            		HttpURLConnection con = (HttpURLConnection)(new URL( result.get(i).getURL() ).openConnection());
            		...
            		vips.startSegmentation(location);		// start segmentation on page
...
>>>>>>> 9ab1e7c24dbb5d9bbd016930bec19e1da6dd3776
